...
urlpatterns = (
    ...
    page('firefox/services', 'firefox/services/index.html'),
    page('firefox/services/monitor', 'firefox/services/monitor.html'),
    page('firefox/services/lockwise', 'firefox/services/lockwise.html'),
    page('firefox/services/send', 'firefox/services/send.html'),
    page('firefox/membership', 'firefox/membership.html'),
    page('firefox/news', 'firefox/news.html'),
    page('firefox/mobile/android', 'firefox/mobile-android.html'),
    page('firefox/mobile/ios', 'firefox/mobile-ios.html'),
    page('firefox/mobile/focus', 'firefox/mobile-focus.html'),
